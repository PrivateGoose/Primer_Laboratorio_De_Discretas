...
namespace Primer_Laboratorio_De_Discretas
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (BigInteger y = 1; y < a - 1; y++) /* a-1 is used because there are already two initial elements in the fibonacci list, and we need the number of elements that are introduced on "a" plus 1 from the for*/
            {
